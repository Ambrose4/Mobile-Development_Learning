...
class RecyclerAdapter(var context: Context)://When you want to toast smthg without intent or activities
    ...
    override fun onBindViewHolder(holder: RecyclerAdapter.ViewHolder, position: Int) {
        ...
        //bind
        // lets assume we have one product
        //we get product_name and place it in the title textview
        //we do the same for cost
        ...
        //image.setImageResource(item.image)
                ...
                holder.itemView.setOnClickListener {
                    // saved the clicked product to share prefferences
                    val prefs = context.getSharedPreferences("db", MODE_PRIVATE)
